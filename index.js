		...
		try {
			...
			switch(command) {
				...
				case 'porno':
					...
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCZlmVDAPBaYf5vHNAeZFQ1goqFlZwY7Yaqw&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Adm deixou? 😳'})
					break
				case 'dono':
					memein = await kagApi.memeindo()
				...
				case 'hentai':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtbJs7FGvrpwr1AV0srNfhph8oooWBViH-Ew&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Cara bate pra 2d 😂'})
					break
				case 'bomdia':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/7VL9cFf.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Bom dia, vcs sao fodas ❤️'}) que
					break
				case 'boatarde':
					memein = await kagApi.memeindo()
				...
				case 'memeindo':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSI9YZVEJqnjop6vl5tc-D-65AWfMcA2xvWJw&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '.......'})
					break
				case 'setprefix':
        ...
        case 'promote':
				...
				case 'kick':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Levou ban o paulista de condomínio filha da puta 😡 : @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'listadmins':
